<?php 
    ...
    echo '<farmer id="contact" ><div class="container"><div class="row">
			<div class="col-md-12 wow fadeInDown" data-wow-delay="2000"><br>
			<table class="body_wrap" style="100%"><tr><td class="main_farmer" valign="top"> 
	...
	echo '</div></td><td valign="top" class="side_farmer">';
	
	//js_my_sidebar();
	
        echo '</td>';

	echo '</tr></table></div></div></div></farmer>';
