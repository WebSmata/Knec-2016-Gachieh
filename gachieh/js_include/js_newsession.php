		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostItem" action="index.php?js_pageaction=newsession" >
				...
				<tr>
                    ...
                    <center>
						<input type="submit" class="submit_this" name="AddSession" value="Save Session"> 
					</center><br></form>
