		...
		<br>
          ...
          <br><hr><br>
			<div class="main_content">
				<form role="form" method="post" name="PostFarmer" action="index.php?js_pageaction=newfarmer" enctype="multipart/form-data" >
                ...
                <tr>
					...
					<td><input type="text" autocomplete="off" name="address"></td>
                        ...
                        <center><input type="submit" class="submit_this" name="AddFarmer" value="Save New Farmer">
			  </center><br></form>
