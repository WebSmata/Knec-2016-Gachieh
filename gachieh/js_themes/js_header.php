<!DOCTYPE html> 
<html>
<?php $js_loggedacc = isset( $_SESSION['js_gachieacc'] ) ? $_SESSION['js_gachieacc'] : ""; ?>
<head>
  ...
  <div id="main">
	...
	<div id="menu-outer">
		<div class="table">
			...
			'<li><a href="index.php?js_pageaction=sessions">Sessions</a></li>
			<li><a href="index.php?js_pageaction=farmers">Farmers</a></li>
			...
			<li><a href="index.php?js_pageaction=manage_username">Manage Employeename</a></li>';
			}
				?>		
			</ul>
		</div>
