<?php
	...
	define( "JS_TARGET", "file:///D:/Web/htdocs/knec/gachie/js_media/" );
	define( "JS_UPLOADS", "file:///D:/Localhost/htdocs/gachie/js_uploads/" );
	...
	define( "JS_E_TOP", '<html><head><title>Something is not Right</title><style>
		...
		#error-farmer { background-color: #F88017;	border: 1px solid #eee; color: #fff; font-weight: bold; padding: 12px ;}				
		#debug { margin-top: 50px; text-align:left;	}
		#lower-farmer { border: 1px solid #eee; margin: 10px 0;padding:10px;  font-size:20px;}
		</style></head><body text="#000000" bgcolor="#ffffff" dir="ltr"><div id="content"><div id="error-farmer" class="rounded">
		<h1>Something is not Right!</h1></div><div id="lower-farmer" class="rounded">');
	...
	define( "JS_I_TOP", '<html><head><title>A Few Fixes</title><style>
		...
		#error-farmer { background-color: #F88017;	border: 1px solid #eee; color: #fff; font-weight: bold; padding: 12px ;}				
		#debug { margin-top: 50px; text-align:left;	}
		#lower-farmer { border: 1px solid #eee; margin: 10px 0;padding:10px;  font-size:20px; background:#fff;}
		</style></head><body text="#000000" bgcolor="#ffffff" dir="ltr"><div id="content"><div id="error-farmer" class="rounded"><h1>');
	define( "JS_I_TOP_A", '</h1></div><div id="lower-farmer" class="rounded">');
